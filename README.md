...
EternalCombat 2.0 has been tested on Minecraft versions **1.17.1 to 26.2**, but it should work seamlessly on most
other versions too.
...
- **Support for newest features**  
  ...
  <img alt="Trident and spear cooldown feature" src="https://github.com/EternalCodeTeam/EternalCombat/blob/master/assets/spear.gif?raw=true" width="420">
...
```kts
compileOnly("com.eternalcode:eternalcombat-api:2.6.0-SNAPSHOT")
```
